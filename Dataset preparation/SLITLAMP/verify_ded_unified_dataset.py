...
DATASET_ROOT = r"E:\Datasets\ded_unified"
IMAGE_DIR = os.path.join(DATASET_ROOT, "images")
CSV_PATH = os.path.join(DATASET_ROOT, "ded_labels.csv")

print("="*60)
print("DED DATASET INTEGRITY CHECK")
print("="*60)
